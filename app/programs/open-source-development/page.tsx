  ...
  return (
    <ProgramLayout
      ...
      pctFee: '1%',
        ...
        overview: `ODIPA's Open-Source Development program produces and maintains free privacy tools under permissive open-source licenses. Our Community Privacy Tools directory lists tools built by ODIPA alongside community projects seeking contributors, with every listing status governed by our published Tool Listing Policy. We also publish privacy engineering guides and host the infrastructure for approved open-source privacy projects. For organizations that build on our tools professionally, we offer fee-based priority support that sustains the free tier for individuals.`,
        whatWeDo: [
        ...
        faqs: [
          ...
          { q: 'Can I submit a tool to ODIPA\'s directory?', a: 'Yes. Use the submission form on our Community Privacy Tools page. Approved listings complete code review, security review, and board approval, and promising early-stage projects can be featured as community projects seeking contributors. Our Tool Listing Policy explains every status.' },
          { q: 'Is business use of ODIPA\'s tools allowed?', a: 'Yes. ODIPA-built tools are MIT licensed and can be used commercially. Community projects in the directory carry their own open-source licenses, shown on each listing. Organizations that depend on ODIPA\'s tools are encouraged to support the project through priority support subscriptions.' },
        ],
